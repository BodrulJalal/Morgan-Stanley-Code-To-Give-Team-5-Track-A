            ...
            {selectedEvent ? (
              <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm ring-1 ring-slate-100">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  ...
                  >
                    {isSelectedEventJoined ? "Joined" : "Join Event"}
                  </button>
                  <button
                    type="button"
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span
                        className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-yellow-300 text-[10px] font-black uppercase shadow-sm"
                        aria-hidden="true"
                      >
                        Map
                      </span>
