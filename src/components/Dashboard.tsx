  ...
  return (
    <div className="flex min-h-screen flex-col bg-amber-50">
      ...
      <main className="flex min-h-0 flex-1 gap-4 p-4 md:p-6">
        <section className="relative min-w-0 flex-1 rounded-3xl bg-green-900/5 p-3 shadow-inner ring-1 ring-green-800/10">
        ...
        <aside className="w-full shrink-0 md:w-[380px]">
          <div className="h-full rounded-3xl bg-white/90 shadow-md ring-1 ring-yellow-200/80 transition-shadow duration-200 hover:shadow-lg">
            <EventPanel
